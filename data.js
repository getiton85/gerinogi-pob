...
DB.runes.armor.push(
  ...[
    {id:"armor_s1_hwangyeong",name:"환영",season:1,tag:"전설",effects:{attackPct:18},rawOption:{description:"공격력이 18% 증가한다. 지속 피해: 정신을 보유한 적 공격 시 방어구 파괴를 부여해 10초 동안 받는 피해를 10% 증가시킨다.",conditionals:[{condition:"정신 지속 피해 대상 공격",durationSec:10,cooldownSec:3,effects:{enemyDamagePct:10}}]}},
    {id:"armor_s1_godae_suhoja",name:"고대 수호자",season:1,tag:"전설",effects:{attackPct:23,movementSpeedPct:-8},rawOption:{description:"공격력이 23% 증가한다. 결함: 이동 속도가 8% 감소한다."}},
    {id:"armor_s1_bawi_gamsija",name:"바위 감시자",season:1,tag:"전설",effects:{attackPct:22},rawOption:{description:"축적: 강타 7회 적중 시 6초 동안 공격력이 22% 증가한다.",conditionals:[{condition:"강타 7회 적중",durationSec:6,effects:{attackPct:22}}]}},
    {id:"armor_s1_sinseonghan_chigyeong",name:"신성한 칙령",season:1,tag:"전설",effects:{attackPct:15,healingPct:9},rawOption:{description:"아군의 체력을 회복시키면 5초 동안 공격력이 15%, 회복량이 9% 증가한다.",conditionals:[{condition:"아군 회복",durationSec:5,effects:{attackPct:15,healingPct:9}}]}},
    {id:"armor_s1_pilsal",name:"필사",season:1,tag:"전설",effects:{attackPct:10},rawOption:{description:"공격력이 10% 증가한다. 체력이 50% 이하로 감소하면 20초 동안 공격력이 20% 추가로 증가한다.",conditionals:[{condition:"체력 50% 이하",durationSec:20,cooldownSec:15,effects:{attackPct:20}}]}},
    {id:"armor_s1_pamyeol_plus",name:"파멸+",season:1,tag:"전설",effects:{attackPct:25},rawOption:{description:"궁극기 사용 시 20초 동안 공격력이 25% 증가한다.",conditionals:[{condition:"궁극기 사용",durationSec:20,effects:{attackPct:25}}]}},
    {id:"armor_s1_yeomyeong_plus",name:"여명+",season:1,tag:"전설",effects:{attackPct:10.5},rawOption:{description:"누적: 스킬 사용 시마다 10초 동안 공격력이 3.5% 증가한다. 최대 6회 중첩된다.",conditionals:[{condition:"스킬 사용 누적",durationSec:10,maxStacks:6,perStack:{attackPct:3.5}}]}},
    {id:"armor_s1_mudoga_plus",name:"무도가+",season:1,tag:"전설",effects:{attackPct:12,ultimateGaugeGainPct:20},rawOption:{description:"공격력이 12% 증가하며, 궁극기 게이지 획득량이 20% 증가한다."}},
    {id:"armor_s1_jeolgae_plus",name:"절개+",season:1,tag:"전설",effects:{attackPct:20},rawOption:{description:"지속 피해: 출혈을 보유한 적 공격 시 5초 동안 공격력이 20% 증가한다.",conditionals:[{condition:"출혈 대상 공격",durationSec:5,cooldownSec:3,effects:{attackPct:20}}]}},
    {id:"armor_s1_hwanggeum_dolpan",name:"황금 돌판",season:1,tag:"전설",effects:{attackPct:20},rawOption:{description:"체력이 75% 이상일 경우 공격력이 20% 증가한다.",conditionals:[{condition:"체력 75% 이상",effects:{attackPct:20}}]}},
    {id:"armor_s1_ttangeullim",name:"땅울림",season:1,tag:"전설",effects:{attackPct:14},rawOption:{description:"공격력이 8% 증가한다. 전투 시작 시 공격력이 30% 증가하고 증가한 공격력은 매 3초마다 2%씩 감소한다.",conditionals:[{condition:"전투 시작",effects:{attackPct:30,decayPer3Sec:2}}]}},
    {id:"armor_s1_geunwibyeong_plus",name:"근위병+",season:1,tag:"전설",effects:{attackPct:23,cooldownRecoveryPct:-7},rawOption:{description:"공격력이 23% 증가한다. 결함: 재사용 대기 시간 회복 속도가 7% 감소한다."}},
    {id:"armor_s1_chimmukhaneun_san",name:"침묵하는 산",season:1,tag:"전설",effects:{attackPct:22},rawOption:{description:"5초 동안 이동하지 않을 경우 공격력이 22% 증가한다.",conditionals:[{condition:"5초간 이동하지 않음",effects:{attackPct:22}}]}},
    {id:"armor_s1_jipjeonggwan",name:"집정관",season:1,tag:"전설",effects:{attackPct:23,skillSpeedPct:-8,castingSpeedPct:-8,chargeSpeedPct:-8},rawOption:{description:"공격력이 23% 증가한다. 결함: 스킬 사용 속도와 캐스팅 및 차지 속도가 8% 감소한다."}},
    {id:"armor_s1_jihwigwan",name:"지휘관",season:1,tag:"전설",effects:{attackPct:13.5},rawOption:{description:"강타, 연타, 무방비, 치명타, 추가타 공격 시 8초 동안 공격력이 4.5% 증가하며 최대 5회 중첩된다.",conditionals:[{condition:"공격 속성 적중",durationSec:8,maxStacks:5,perStack:{attackPct:4.5}}]}},
    {id:"armor_s1_jeomuneun_dal",name:"저무는 달",season:1,tag:"전설",effects:{attackPct:12,defensePct:6},rawOption:{description:"누적: 공격력과 방어력이 6% 증가한다. 전투 시작 시 전투 종료까지 30초마다 공격력과 방어력이 2%씩 추가 증가하며 최대 10회 중첩된다."}},
    {id:"armor_s1_sinjeon_gisa",name:"신전 기사",season:1,tag:"전설",effects:{attackPct:23,critChancePct:-8},rawOption:{description:"공격력이 23% 증가한다. 결함: 치명타 확률이 8% 감소한다."}},
    {id:"armor_s1_seongyeok_plus",name:"성역+",season:1,tag:"전설",effects:{attackPct:17},rawOption:{description:"보호막 계열 효과가 유지되는 동안 공격력이 17% 증가한다. 포션 사용 또는 30초가 지나면 피해를 흡수하는 보호막을 생성한다.",conditionals:[{condition:"보호막 유지",effects:{attackPct:17}}]}},
    {id:"armor_s1_eungjing_plus",name:"응징+",season:1,tag:"전설",effects:{attackPct:12},rawOption:{description:"공격력이 12% 증가한다. 자신과 전투 중인 적이 처치되었을 경우 자신의 체력을 회복한다."}},
    {id:"armor_s1_dolgyeokdaejang_plus",name:"돌격대장+",season:1,tag:"전설",effects:{enemyDamagePct:20},rawOption:{description:"적을 도발할 경우 방어구 파괴를 부여해 10초 동안 받는 피해를 10% 증가시키며, 자신에게 15초 동안 적에게 주는 피해를 20% 증가시킨다.",conditionals:[{condition:"도발",durationSec:15,effects:{enemyDamagePct:20}}]}},
    {id:"armor_s1_jipnyeom_plus",name:"집념+",season:1,tag:"전설",effects:{castingSpeedPct:25,chargeSpeedPct:25,enemyDamagePct:10},rawOption:{description:"캐스팅 및 차지 속도가 25%, 적에게 주는 피해가 10% 증가한다."}},
    {id:"armor_s1_bulsa",name:"불사",season:1,tag:"전설",effects:{enemyDamagePct:18},rawOption:{description:"적에게 주는 피해가 18% 증가한다. 행동 불능에 이르는 공격을 1회 막아주고 체력을 대량 회복한 뒤 3초 동안 받는 피해가 80% 감소한다.",conditionals:[{condition:"행동 불능 방지",durationSec:3,cooldownSec:180,effects:{damageReductionPct:80}}]}},
    {id:"armor_s1_junbidoen_ja",name:"준비된 자",season:1,tag:"전설",effects:{enemyDamagePct:20},rawOption:{description:"퀵슬롯 아이템을 사용했을 경우 15초 동안 적에게 주는 피해가 20% 증가한다. 퀵슬롯 포션과 붕대 개수가 2개 증가한다.",conditionals:[{condition:"퀵슬롯 아이템 사용",durationSec:15,effects:{enemyDamagePct:20}}]}},
    {id:"armor_s1_hwanghon",name:"황혼",season:1,tag:"전설",effects:{enemyDamagePct:11.2},rawOption:{description:"누적: 공격 적중 때마다 8초 동안 적에게 주는 피해가 1.4% 증가한다. 최대 16회 중첩된다.",conditionals:[{condition:"공격 적중 누적",durationSec:8,maxStacks:16,perStack:{enemyDamagePct:1.4}}]}},
    {id:"armor_s1_hwangpye_plus",name:"황폐+",season:1,tag:"전설",effects:{enemyDamagePct:12,extraHitChancePct:7},rawOption:{description:"보유한 자원이 50% 미만일 경우 적에게 주는 피해가 12%, 추가타 확률이 7% 증가한다.",conditionals:[{condition:"자원 50% 미만",effects:{enemyDamagePct:12,extraHitChancePct:7}}]}},
    {id:"armor_s1_buranjeonghan_him",name:"불안정한 힘",season:1,tag:"전설",effects:{enemyDamagePct:22},rawOption:{description:"전투 시작 시 적에게 주는 피해가 22% 증가한다. 브레이크 당할 경우 효과가 사라지며 30초 후 재활성화된다.",conditionals:[{condition:"전투 시작",effects:{enemyDamagePct:22}}]}},
    {id:"armor_s1_kalkwibaltop_plus",name:"칼퀴발톱+",season:1,tag:"전설",effects:{breakSkillDamagePct:24,breakExtraDamagePct:24,unarmoredDamagePct:24},rawOption:{description:"브레이크 스킬로 주는 피해가 24% 증가한다. 추가로 브레이크 피해와 무방비 피해가 24% 증가한다."}},
    {id:"armor_s1_bunswae_plus",name:"분쇄+",season:1,tag:"전설",effects:{attackPct:6},rawOption:{description:"공격력이 6% 증가한다. 무방비 공격 적중 시 10초 동안 적에게 주는 피해가 28% 증가한다.",conditionals:[{condition:"무방비 공격 적중",durationSec:10,effects:{enemyDamagePct:28}}]}},
    {id:"armor_s1_ssaumkkun",name:"싸움꾼",season:1,tag:"전설",effects:{enemyDamagePct:14},rawOption:{description:"주변 6m 범위 내 적의 수가 많을수록 적에게 입히는 피해가 최소 12%에서 최대 16%까지 증가한다."}},
    {id:"armor_s1_deulbul",name:"들불",season:1,tag:"전설",effects:{critChancePct:14},rawOption:{description:"지속 피해: 화상을 보유한 적 공격 시 5초 동안 치명타 확률이 14% 증가한다.",conditionals:[{condition:"화상 대상 공격",durationSec:5,cooldownSec:3,effects:{critChancePct:14}}]}},
    {id:"armor_s1_seolsan",name:"설산",season:1,tag:"전설",effects:{extraHitChancePct:16},rawOption:{description:"지속 피해: 빙결을 보유한 적 공격 시 5초 동안 추가타 확률이 16% 증가한다.",conditionals:[{condition:"빙결 대상 공격",durationSec:5,cooldownSec:3,effects:{extraHitChancePct:16}}]}},
    {id:"armor_s1_yuseong",name:"유성",season:1,tag:"전설",effects:{enemyDamagePct:6},directDps:5804.8,rawOption:{description:"거신의 파편. 공격 시, 적에게 87072의 피해를 준다. 보유한 모든 충전을 전력으로 변환하고, 변환된 전력 수치 x 907만큼의 피해를 추가로 준다. 재사용 대기 시간 15초. 100 이상의 전력을 보유한 상태에서 각성 혹은 궁극기 사용 시 과부하 상태가 된다. 과부하 중 1초마다 현재 타깃 주변 3.5m 범위 내 적들에게 38780의 피해를 주는 마력포를 발사하고 100의 전력을 소모한다. 전력이 100 미만이 되면 즉시 과부하가 종료된다.",expectedUptimeHint:"giant_fragment awakening resource cycle",conditionals:[{condition:"공격 적중",durationSec:15,cooldownSec:15,effects:{enemyDamagePct:6}},{condition:"전력 100 이상 각성/궁극기 사용",durationSec:3,cooldownSec:15,effects:{enemyDamagePct:6}}]}},
    {id:"armor_s1_chosinseong",name:"초신성",season:1,tag:"전설",effects:{attackPct:7},directDps:2590,rawOption:{description:"거신의 파편. 공격 시, 적에게 38850의 피해를 주고 15초 동안 공격력이 5% 증가한다. 보유한 모든 충전을 전력으로 변환하고, 변환된 전력 1마다 518의 피해를 추가로 주며, 0.04%만큼 공격력이 추가로 증가한다. 재사용 대기 시간 15초. 각성 혹은 궁극기 사용 시 전력을 모두 소모하여 주변 10m 범위 내의 적들에게 전력 수치 x 388의 피해를 준다.",expectedUptimeHint:"giant_fragment awakening resource cycle",conditionals:[{condition:"공격 적중",durationSec:15,cooldownSec:15,effects:{attackPct:7}},{condition:"각성 또는 궁극기 사용",durationSec:1,cooldownSec:15,effects:{enemyDamagePct:3}}]}},
    {id:"armor_s1_changbaekhan_seomgwang",name:"창백한 섬광",season:1,tag:"전설",effects:{critChancePct:9,critDamagePct:8},rawOption:{description:"거신의 파편. 공격 시, 치명타 확률이 15초 동안 8% 증가한다. 보유한 모든 충전을 전력으로 변환하고 변환된 전력 수치 x 0.09%만큼 치명타 확률이 추가로 증가한다. 재사용 대기 시간 15초. 50 이상의 전력을 보유한 상태에서 각성 혹은 궁극기 사용 시 과부하 상태가 된다. 과부하 중 치명타 피해가 32% 증가하며, 1초마다 50의 전력을 소모한다. 전력이 50 미만이 될 경우 즉시 과부하가 종료된다.",expectedUptimeHint:"giant_fragment awakening resource cycle crit",conditionals:[{condition:"공격 적중",durationSec:15,cooldownSec:15,effects:{critChancePct:9}},{condition:"전력 50 이상 각성/궁극기 사용",durationSec:4,cooldownSec:15,effects:{critDamagePct:32}}]}},
    {id:"armor_s1_illeongineun_bulkkoch",name:"일렁이는 불꽃",season:1,tag:"전설",effects:{extraHitChancePct:9,enemyDamagePct:4},rawOption:{description:"거신의 파편. 공격 시, 추가타 확률이 15초 동안 8% 증가한다. 보유한 모든 충전을 전력으로 변환하고 변환된 전력 수치 x 0.09%만큼 추가타 확률이 추가로 증가한다. 재사용 대기 시간 15초. 50 이상의 전력을 보유한 상태에서 각성 혹은 궁극기 사용 시 과부하 상태가 된다. 과부하 중 공격 적중 시 선행 타격의 30% 피해를 주는 추가 공격이 발생하며, 1초마다 50의 전력을 소모한다. 전력이 50 미만이 될 경우 즉시 과부하가 종료된다.",expectedUptimeHint:"giant_fragment awakening resource cycle extra",conditionals:[{condition:"공격 적중",durationSec:15,cooldownSec:15,effects:{extraHitChancePct:9}},{condition:"전력 50 이상 각성/궁극기 사용",durationSec:4,cooldownSec:15,effects:{enemyDamagePct:4}}]}},
    {id:"armor_s1_ullyeopeojineun_cheondung",name:"울려퍼지는 천둥",season:1,tag:"전설",effects:{skillSpeedPct:8,attackSpeedPct:8,castingSpeedPct:8,chargeSpeedPct:8},directDps:2585.3333333333335,rawOption:{description:"거신의 파편. 공격 시 스킬 사용 속도, 공격 속도, 캐스팅 및 차지 속도가 15초 동안 6% 증가한다. 보유한 모든 충전을 전력으로 변환하고 변환된 전력 수치 x 0.06%만큼 스킬 사용 속도, 공격 속도, 캐스팅 및 차지 속도가 추가로 증가한다. 재사용 대기 시간 15초. 100 이상의 전력을 보유한 상태에서 각성 혹은 궁극기 사용 시 과부하 상태가 된다. 과부하 중 공격 적중 시 대상 방향으로 전력을 방출하여 38780의 피해를 주고 100의 전력을 소모한다. 전력이 100 미만이 될 경우 즉시 과부하가 종료된다.",expectedUptimeHint:"giant_fragment awakening resource cycle speed",conditionals:[{condition:"공격 적중",durationSec:15,cooldownSec:15,effects:{skillSpeedPct:8,attackSpeedPct:8,castingSpeedPct:8,chargeSpeedPct:8}},{condition:"전력 100 이상 각성/궁극기 사용",durationSec:3,cooldownSec:15,effects:{enemyDamagePct:4}}]}},
    {id:"armor_s1_beongae_chaejjik",name:"번개 채찍",season:1,tag:"전설",effects:{enemyDamagePct:11},directDps:2585.3333333333335,rawOption:{description:"거신의 파편. 공격 시, 적에게 주는 피해가 15초 동안 9% 증가한다. 보유한 모든 충전을 전력으로 변환하고 변환된 전력 수치 x 0.09%만큼 적에게 주는 피해가 추가로 증가한다. 재사용 대기 시간 15초. 100 이상의 전력을 보유한 상태에서 각성 혹은 궁극기 사용 시 과부하 상태가 된다. 과부하 중 공격 적중 시 대상 방향으로 시술을 휘둘러 38780의 피해를 주고 100의 전력을 소모한다. 전력이 100 미만이 될 경우 즉시 과부하가 종료된다.",expectedUptimeHint:"giant_fragment awakening resource cycle damage",conditionals:[{condition:"공격 적중",durationSec:15,cooldownSec:15,effects:{enemyDamagePct:11}},{condition:"전력 100 이상 각성/궁극기 사용",durationSec:3,cooldownSec:15,effects:{enemyDamagePct:4}}]}},
    {id:"armor_s1_nun_meon_yeeonja",name:"눈 먼 예언자",season:1,tag:"전설",effects:{cooldownFlatSec:38},rawOption:{description:"각성의 재사용 대기 시간이 38초 감소한다."}},
    {id:"armor_s1_apdojeogin_him",name:"압도적인 힘",season:1,tag:"전설",effects:{strongHitDamagePct:6,attackPct:6,critChancePct:4},rawOption:{description:"강타 피해가 6%, 공격력이 6%, 치명타 확률이 4% 증가한다. 엠블럼의 각성 효과 활성화 때 20초간 이 룬으로 증가한 능력치가 두 배가 된다."}},
    {id:"armor_s1_seomsehan_sonnollim",name:"섬세한 손놀림",season:1,tag:"전설",effects:{multiHitDamagePct:6,attackPct:6,extraHitChancePct:4},rawOption:{description:"연타 피해가 6%, 공격력이 6%, 추가타 확률이 4% 증가한다. 엠블럼의 각성 효과 활성화 때 20초간 이 룬으로 증가한 능력치가 두 배가 된다."}},
    {id:"armor_s1_pureun_girok",name:"푸른 기록",season:1,tag:"전설",effects:{skillDamagePct:11},rawOption:{description:"축적: 스킬을 5회 사용 시 전투 종료 시까지 스킬 피해량이 2.2% 증가한다. 최대 10회 중첩된다.",conditionals:[{condition:"스킬 5회 사용 누적",maxStacks:10,perStack:{skillDamagePct:2.2}}]}},
    {id:"armor_s1_swaedo_plus",name:"쇄도+",season:1,tag:"전설",effects:{skillSpeedPct:5,castingSpeedPct:5,chargeSpeedPct:5},rawOption:{description:"스킬 사용 시 25% 확률로 5초 동안 캐스팅 및 차지 속도와 스킬 사용 속도가 20% 증가한다.",conditionals:[{condition:"스킬 사용 확률 발동",durationSec:5,effects:{skillSpeedPct:20,castingSpeedPct:20,chargeSpeedPct:20}}]}},
    {id:"armor_s1_saebyeokbyeol",name:"새벽별",season:1,tag:"전설",effects:{cooldownRecoveryPct:9},rawOption:{description:"누적: 스킬을 사용할 때마다 8초 동안 스킬 재사용 대기 시간 회복 속도가 3% 빨라진다. 최대 6회 중첩된다.",conditionals:[{condition:"스킬 사용 누적",durationSec:8,maxStacks:6,perStack:{cooldownRecoveryPct:3}}]}},
    {id:"armor_s1_yojeong_muri",name:"요정 무리",season:1,tag:"전설",effects:{cooldownFlatSec:2.1},rawOption:{description:"축적: 스킬을 7회 사용 시 모든 스킬의 재사용 대기 시간이 2.1초 감소한다.",conditionals:[{condition:"스킬 7회 사용",cooldownSec:3,effects:{cooldownFlatSec:2.1}}]}},
    {id:"armor_s1_emerald_sup",name:"에메랄드 숲",season:1,tag:"전설",effects:{enemyDamagePct:10},rawOption:{description:"축적: 효과에 필요한 횟수를 누적시킬 때 1회 추가로 누적시킨다. 적에게 주는 피해가 10% 증가한다."}},
    {id:"armor_s1_ssangdungi_byeol",name:"쌍둥이 별",season:1,tag:"전설",effects:{castingSpeedPct:7,chargeSpeedPct:7,skillSpeedPct:7},rawOption:{description:"누적 효과가 발생할 때 추가로 한 번 더 발생한다. 캐스팅 및 차지 속도, 스킬 사용 속도가 7% 증가한다."}},
    {id:"armor_s1_yaktalja",name:"약탈자",season:1,tag:"전설",effects:{extraHitChancePct:10},rawOption:{description:"추가타 적중 시 체력이 회복된다. 추가타 확률이 10% 증가한다.",conditionals:[{condition:"추가타 적중",cooldownSec:1,effects:{healingPct:1}}]}},
    {id:"armor_s1_haegyeolsa_plus",name:"해결사+",season:1,tag:"전설",effects:{attackSpeedPct:30,basicExtraHitChancePct:30},rawOption:{description:"공격 속도가 30% 증가하며, 기본 공격의 추가타 확률이 30% 증가한다."}},
    {id:"armor_s1_morae_pokpung",name:"모래 폭풍",season:1,tag:"전설",effects:{skillSpeedPct:10,attackSpeedPct:10},rawOption:{description:"스킬 사용 속도 및 공격 속도가 10% 증가한다. 무방비 공격 적중 시 10초 동안 스킬 사용 속도 및 공격 속도가 24% 추가 증가한다.",conditionals:[{condition:"무방비 공격 적중",durationSec:10,effects:{skillSpeedPct:24,attackSpeedPct:24}}]}},
    {id:"armor_s1_eoduun_jingjo",name:"어두운 징조",season:1,tag:"전설",effects:{attackPct:6,critChancePct:6,enemyDamagePct:6},rawOption:{description:"누적: 궁극기 사용 시 전투가 끝날 때까지 공격력, 치명타 확률, 적에게 주는 피해가 0.6% 증가한다. 최대 30회 중첩된다.",conditionals:[{condition:"궁극기 사용 누적",maxStacks:30,perStack:{attackPct:0.6,critChancePct:0.6,enemyDamagePct:0.6}}]}},
    {id:"armor_s1_taeyang",name:"태양",season:1,tag:"전설",effects:{},rawOption:{description:"3.5초마다 자신 주위 3m 범위 내의 적에게 피해를 준다.",conditionals:[{condition:"주기 피해",intervalSec:3.5}]}},
    {id:"armor_s1_ssakssilbaram",name:"싹쓸바람",season:1,tag:"전설",effects:{},rawOption:{description:"공격 적중 시 대상 주위 5m 범위 내의 적들을 중앙으로 3초간 끌어당기며 매 0.5초마다 피해를 준다.",conditionals:[{condition:"공격 적중",durationSec:3,cooldownSec:10,intervalSec:0.5}]}},
    {id:"armor_s1_sujeong_kkochip",name:"수정 꽃잎",season:1,tag:"전설",effects:{attackPct:12},rawOption:{description:"축적: 치명타 공격을 6회 적중시키면 다음 공격 적중 시 피해를 입히고 자신의 공격력이 10초 동안 12% 증가한다.",conditionals:[{condition:"치명타 6회 적중",durationSec:10,cooldownSec:3,effects:{attackPct:12}}]}},
    {id:"armor_s1_hondon",name:"혼돈",season:1,tag:"전설",effects:{},rawOption:{description:"자신의 공격에 적중한 대상이 지속 피해 효과를 받을 때마다 중첩을 쌓고, 중첩이 3회 쌓이면 피해를 준다."}},
    {id:"armor_s1_bunggihaneun_byeol",name:"붕괴하는 별",season:1,tag:"전설",effects:{enemyDamagePct:10},rawOption:{description:"자신의 공격이 적에게 적중할 때마다 중첩을 쌓는다. 중첩이 3회 쌓이면 중첩을 소모해 피해를 주고 10초 동안 적에게 주는 피해를 10% 증가시킨다.",conditionals:[{condition:"공격 적중 3회",durationSec:10,effects:{enemyDamagePct:10}}]}},
    {id:"armor_s1_wonso_johwa",name:"원소 조화",season:1,tag:"전설",effects:{},rawOption:{description:"공격 적중 시 전방 10m 범위 내의 적에게 화염, 냉기, 번개 속성 투사체를 발사해 피해를 입힌다.",conditionals:[{condition:"공격 적중",cooldownSec:5}]}},
    {id:"armor_s1_namu_saseul",name:"나무 사슬",season:1,tag:"전설",effects:{attackPct:12},rawOption:{description:"축적: 추가타 공격을 6회 적중시키면 다음 공격 적중 시 피해를 입히고 자신의 공격력이 10초 동안 12% 증가한다.",conditionals:[{condition:"추가타 6회 적중",durationSec:10,cooldownSec:4,effects:{attackPct:12}}]}},
    {id:"armor_s1_dagaoneun_jugeum",name:"다가오는 죽음",season:1,tag:"전설",effects:{},rawOption:{description:"적을 향해 느리게 날아가는 암흑 구체를 발사한다. 암흑 구체가 날아간 거리에 비례하여 피해를 입히고 18m 거리에서 최대 피해를 입힌다.",conditionals:[{condition:"암흑 구체",cooldownSec:10}]}},
    {id:"armor_s1_ithin_seongso",name:"잊힌 성소",season:1,tag:"전설",effects:{},rawOption:{description:"축적: 스킬 혹은 기본 공격을 60회 사용 시 화염, 번개 혹은 얼음의 힘으로 스스로를 감싸 주위 2.5m 범위에 5초 동안 0.1초마다 원소 화살을 난사한다."}}
  ].filter(r=>!DB.runes.armor.some(existing=>existing.id===r.id))
);
