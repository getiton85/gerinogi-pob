...
if(Math.abs(base.valueScore-100)>0.001) throw new Error('baseline value not 100');
if(changed.valueScore===100) throw new Error('candidate delta not computed');
console.log(JSON.stringify({base:base.valueScore,changed:changed.valueScore,diff:changed.diffPct}));
